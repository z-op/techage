return {
  ...
  texts = {
    ...
    "\n"..
    "Производительность - одно ведро воды каждые 8 с. Наполнитель жидкостями требует 3 ku энергии.\n"..
    "\n"..
    "\n"..
    "\n",
    ...
    "Вы можете перемещать блок загрузки карты внутри блока карты как угодно\\, положение автоматически загружаемого блока карты остается неизменным.\n"..
    "\n"..
    "\n"..
    "\n",
  },
