return {
  ...
  texts = {
    ...
    "\n"..
    "\n",
    "Монитор CRT доступен для работы с терминалом TA3 в режиме BASIC. На нём может отображаться вывод программы на BASIC.\n"..
    "Монитор также может использоваться как дисплей для других блоков\\, выводящих текст (например\\, Lua контроллера).\n"..
    "Монитор имеет меню гаечного ключа\\, в котором можно настроить разрешение монитора и цвет текста.\n"..
    "Разрешение можно устанавливать в диапазоне от 16x8 до 40x20 символов x строк.\n"..
    "Частота обновления монитора напрямую зависит от разрешения и составляет одну секунду при 16x8 и около 6 секунд при 40x20.\n"..
    "\n"..
    ...
    "\n"..
    "\n",
    "Смотровое окно — это блок\\, который служит окном в трубу. Его можно использовать для наблюдения за предметами в трубах.\n"..
    "Блок окна должен быть размещён между двумя трубами. Два или более оконных блока подряд не допускаются. Анимация предметов\n"..
    "происходит только когда игрок находится рядом (<=8 блоков). Однако предметы проходят независимо от видимости.\n"..
    "\n",
    "",
    ...
    "\n"..
    "Блок\\, который ранее был удален с помощью аккумуляторной отвёртки и должен быть помещён снова\\, должен находиться в слоте 1 панели быстрого доступа (крайний левый слот хотбара).\n"..
    "\n"..
    "\n"..
    "\n",
  },
