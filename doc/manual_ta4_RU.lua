return {
  ...
  texts = {
    ...
    "\n"..
    "  - TA4 Дисплей / TA4 Дисплей XL: отображение 5 строк текста пропорциональным шрифтом.\n"..
    "  - TA4 Дисплей II / TA4 Дисплей II XXL: отображение до 20 строк текста моноширинным шрифтом.\n"..
    "\n"..
    ...
    "и поэтому состоит из центрального блока \"TA4 Display II XXL inside\" и ещё 8 блоков \"TA4 Display II XXL outside\", которые должны\n"..
    "быть размещены вокруг центрального блока соответствующим образом.\n"..
    "\n"..
    "\n"..
    "\n",
    "\n",
