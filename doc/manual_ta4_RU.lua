return {
  ...
  texts = {
    ...
    "\n"..
    "Примечание 2: Резервуары или бункеры с разным содержимым не должны быть соединены в систему трубопроводов. Напротив\\, несколько резервуаров или бункеров с одинаковым содержимым могут быть подвешены параллельно на одной линии.\n"..
    "\n"..
    ...
    "\n"..
    "\n",
    "Techage предлагает различные дисплеи для отображения текста. Дисплеи могут использоваться через Lua контроллер\\,\n"..
    "а также через ICTA контроллер или через TA3 терминал.\n"..
    "\n"..
    "  - TA4 Дисплей / TA4 Дисплей XL: отображение 5 строк текста пропорциональным шрифтом. Гибкая ширина символов позволяет отображать разное количество символов в строке.\n"..
    "  - TA4 Дисплей II / TA4 Дисплей II XXL: отображение до 20 строк текста моноширинным шрифтом. Максимальное количество символов в строке задаётся в настройках.\n"..
    "\n"..
    "После установки все дисплеи показывают свой номер. По этому номеру к дисплею можно обращаться. Все дисплеи имеют одинаковые команды управления.\n"..
    "\n"..
    "Команды для управления в режиме BASIC:\n"..
    "\n"..
    "    10 DCLR(num)              ' Очистить экран с номером 'num'.\n"..
    "    20 DPUTS(num\\, row\\, text)  ' Вывод текста на экран в строку 'row' (1..n).\n"..
    "                              ' Значение 0 для 'row' означает\\, что текст\n"..
    "                              ' будет добавлен после последней строки.\n"..
    "\n"..
    "Команды для управления с помощью Lua контроллера:\n"..
    "\n"..
    "    $clear_screen(num)        -- Очистить экран с номером 'num'.\n"..
    "    $display(num\\, row\\, text)  -- Вывод текста на экран в строку 'row' (1..n).\n"..
    "                              -- Значение 0 для 'row' означает\\, что текст\n"..
    "                              -- будет добавлен после последней строки.\n"..
    "\n"..
    "\n"..
    ...
    "\n"..
    "\n",
    "TA4 Дисплей XL в два раза больше TA4 дисплея.\n"..
    "\n"..
    "Строки текста всегда выравниваются по левому краю. Если текст должен быть выровнен по горизонтали\\, перед ним должен стоять символ \"t\" (табулятор).\n"..
    "\n"..
    ...
    "\n"..
    "\n",
    "Дисплей можно гибко настроить. Количество строк и символов в строке\\,\n"..
    "а также цвет текста и фона можно установить через меню гаечного ключа:\n"..
    "\n"..
    "  - Разрешение экрана можно установить в диапазоне от 16x8 до 40x20 символов x строк.\n"..
    "  - Цвет текста можно задать кодом цвета в диапазоне от 0 до 63.\n"..
    "  - Цвет фона также можно задать кодом цвета в диапазоне от 0 до 63.\n"..
    "\n"..
    "Чат-команда '/ta_color64' показывает палитру цветов с кодами.\n"..
    "\n"..
    "Частота обновления дисплея напрямую зависит от разрешения и составляет одну секунду при 16x8 и около 6 секунд при 40x20.\n"..
    "\n"..
    "\n"..
    "\n",
    "Для XXL дисплея действуют те же настройки\\, что и для Дисплея II. Однако XXL дисплей в 9 раз больше Дисплея II\n"..
    "и поэтому состоит из центрального блока \"TA4 Display II XXL inside\" и ещё 8 блоков \"TA4 Display II XXL outside\"\\, которые\n"..
    "должны быть размещены вокруг центрального блока соответствующим образом.\n"..
    "\n"..
    "\n"..
    "\n",
    "",
    ...
    "Кроме того\\, радиус поиска можно настроить через меню гаечного ключа. Радиус можно задать от 1 до 8 блоков (по умолчанию: 4).\n"..
    "\n"..
    "\n"..
    "\n",
    "\n"..
